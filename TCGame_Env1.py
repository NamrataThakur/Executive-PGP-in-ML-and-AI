...
class TicTacToe():
    ...
    def state_transition(self, curr_state, curr_action):
        ...
        """
        new_curr_state = [i for i in curr_state]
        new_curr_state[curr_action[0]] = curr_action[1]
    ...
    def step(self, curr_state, curr_action):
        ...
        has_reached_terminal_state, message = self.is_terminal(new_curr_state)
        ...
        if has_reached_terminal_state:
            ...
            return (new_curr_state, reward, has_reached_terminal_state)
        else:
            _, env_actions = self.action_space(new_curr_state)
            env_action = random.choice([ac for i, ac in enumerate(env_actions)])
            
            new_state_post_env_action = self.state_transition(new_curr_state, env_action)
            ...
            return (new_state_post_env_action, reward, has_reached_terminal_state)
